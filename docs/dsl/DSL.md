Domain Specific Languages (DSL) (Ngôn ngữ đặc tả miền) là ngôn ngữ lập trình chuyên biệt, giúp BA mô tả quy trình nghiệp vụ phức tạp một cách dễ hiểu, chính xác, giảm thiểu khoảng cách giữa yêu cầu kinh doanh và mã nguồn. DSL giúp tăng năng suất, dễ đọc, dễ bảo trì, ví dụ phổ biến bao gồm SQL, HTML, hoặc cấu hình quy tắc kinh doanh. 
